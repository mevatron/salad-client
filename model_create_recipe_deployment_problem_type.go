...
const (
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_BILLING_INFORMATION_REQUIRED CreateRecipeDeploymentProblemType = "billing_information_required"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_CREATED_QUOTA_EXCEEDED CreateRecipeDeploymentProblemType = "created_quota_exceeded"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_NAME_CONFLICT CreateRecipeDeploymentProblemType = "name_conflict"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_PROJECT_NOT_FOUND CreateRecipeDeploymentProblemType = "project_not_found"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_UNEXPECTED_ERROR CreateRecipeDeploymentProblemType = "unexpected_error"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_ORGANIZATION_NOT_FOUND CreateRecipeDeploymentProblemType = "organization_not_found"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_RECIPE_NOT_FOUND CreateRecipeDeploymentProblemType = "recipe_not_found"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_CREATED_INSTANCE_QUOTA_EXCEEDED CreateRecipeDeploymentProblemType = "created_instance_quota_exceeded"
	CREATERECIPEDEPLOYMENTPROBLEMTYPE_NULL CreateRecipeDeploymentProblemType = "null"
)
