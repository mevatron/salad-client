...
------------ | ------------- | ------------- | -------------
**Type** | Pointer to **NullableString** | The URI reference that identifies the problem type | [optional] [default to "about:blank"]
**Title** | Pointer to **NullableString** | A short, human-readable summary of the problem type | [optional] 
**Status** | Pointer to **NullableInt32** | The HTTP status code generated by the origin server | [optional] 
**Detail** | Pointer to **NullableString** | A human-readable explanation specific to this occurrence of the problem | [optional] 
**Instance** | Pointer to **NullableString** | The URI reference that identifies the specific occurrence of the problem | [optional] 
