...
type _UpdateContainerLogging UpdateContainerLogging
...
func (o *UpdateContainerLogging) UnmarshalJSON(data []byte) (err error) {
	varUpdateContainerLogging := _UpdateContainerLogging{}

	err = json.Unmarshal(data, &varUpdateContainerLogging)

	if err != nil {
		return err
	}

	*o = UpdateContainerLogging(varUpdateContainerLogging)
