...
const (
	UPDATERECIPEDEPLOYMENTPROBLEMTYPE_UPDATED_INSTANCE_QUOTA_EXCEEDED UpdateRecipeDeploymentProblemType = "updated_instance_quota_exceeded"
	UPDATERECIPEDEPLOYMENTPROBLEMTYPE_NULL UpdateRecipeDeploymentProblemType = "null"
)
