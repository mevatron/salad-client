...
const (
	ORGANIZATION_NOT_FOUND ReallocateContainerGroupInstanceProblemType = "organization_not_found"
	CONTAINER_GROUP_NOT_FOUND ReallocateContainerGroupInstanceProblemType = "container_group_not_found"
	NODE_NOT_SCHEDULED ReallocateContainerGroupInstanceProblemType = "node_not_scheduled"
	CONTAINER_GROUP_INSTANCE_NOT_FOUND ReallocateContainerGroupInstanceProblemType = "container_group_instance_not_found"
	ORGANIZATION_QUOTAS_NOT_DEFINED ReallocateContainerGroupInstanceProblemType = "organization_quotas_not_defined"
	TOO_MANY_REQUESTS ReallocateContainerGroupInstanceProblemType = "too_many_requests"
	UNEXPECTED_ERROR ReallocateContainerGroupInstanceProblemType = "unexpected_error"
	NULL ReallocateContainerGroupInstanceProblemType = "null"
)
