...
func Test_saladclient_InferenceEndpointsAPIService(t *testing.T) {
	...
	t.Run("Test InferenceEndpointsAPIService ListInferenceEndpointJobs", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.InferenceEndpointsAPI.ListInferenceEndpointJobs(context.Background(), organizationName, inferenceEndpointName).Execute()
