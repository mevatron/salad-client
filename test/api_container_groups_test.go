...
import (
	"context"
	openapiclient "github.com/SaladTechn
...
func Test_saladclient_ContainerGroupsAPIService(t *testing.T) {
	...
	t.Run("Test ContainerGroupsAPIService UpdateContainerGroupInstance", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.ContainerGroupsAPI.UpdateContainerGroupInstance(context.Background(), organizationName, projectName, containerGroupName, containerGroupInstanceId).Execute()
