...
const (
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_ORGANIZATION_NOT_FOUND RecreateContainerGroupInstanceProblemType = "organization_not_found"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_CONTAINER_GROUP_NOT_FOUND RecreateContainerGroupInstanceProblemType = "container_group_not_found"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_NODE_NOT_SCHEDULED RecreateContainerGroupInstanceProblemType = "node_not_scheduled"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_CONTAINER_GROUP_INSTANCE_NOT_FOUND RecreateContainerGroupInstanceProblemType = "container_group_instance_not_found"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_ORGANIZATION_QUOTAS_NOT_DEFINED RecreateContainerGroupInstanceProblemType = "organization_quotas_not_defined"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_TOO_MANY_REQUESTS RecreateContainerGroupInstanceProblemType = "too_many_requests"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_UNEXPECTED_ERROR RecreateContainerGroupInstanceProblemType = "unexpected_error"
	RECREATECONTAINERGROUPINSTANCEPROBLEMTYPE_NULL RecreateContainerGroupInstanceProblemType = "null"
)
