...
// APIClient manages communication with the SaladCloud Public API API v1.0.0-alpha.56
...
type APIClient struct {
	...
	RecipeDeploymentsAPI *RecipeDeploymentsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RecipeDeploymentsAPI = (*RecipeDeploymentsAPIService)(&c.common)
